...
from .utils.io import load_yaml, print_warning
from .utils import wandb_local as wandb_local


cfg = CN()

DEFAULT_CONFIG_FILE = os.path.join("causal_flows", "causal_nf", "configs", "default_config.yaml")
...
def parse_args():
    ...
    # AM: Adding
    parser.add_argument("--pscf_analysis", action="store_true")
